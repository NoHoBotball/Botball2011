...
//I put the following declarations in
//begin
...
void create_script_turn(int deg, int speed);
void create_script_arc(int rad, int deg, int speed);
void create_script_start();
int create_do_move(int dist, int speed);
int create_do_move_direct(int dist, int r_speed, int l_speed);
int create_do_arc(int rad, int deg, int speed);
int create_do_turn(int deg, int speed);
