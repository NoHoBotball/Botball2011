...
#define motorR 0
#define dragr 0.97 
#define dragl 1//Used to slow down the left wheel
...
void reverseStraight(int speed, int tspeed);
...
void forward(int speed)
{
	mav(motorL, speed*dragl);
	mav(motorR, speed * dragr);
}
