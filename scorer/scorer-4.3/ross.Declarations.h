...
#ifdef	ROSS_CONFIG_OPEN
#ifndef	ROSS_CONFIG_CLOSE
extern BOOL enabledBackEMF();
#define	ROSS_CONFIG_CLOSE
#endif
#endif

//Ross's Math Library Declarations
#ifdef 	ROSS_MATH_OPEN
